...
export default function RetroGrid({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 [transform:rotateX(35deg)]">
        <div
          className={cn(
            ...
            "[background-repeat:repeat] [background-size:60px_60px] [height:300vh] [inset:0%_0px] [margin-left:-130%] [transform-origin:50%_0_0] [width:600vw]",
      ...
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-t from-background to-transparent 90% dark:from-black" />
    </div>
  );
}

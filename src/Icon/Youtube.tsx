...
const Youtube: React.FC<{ width: string, height: string, color: string }> = ({ width, height, color }) => {
    return (
        <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" className={cn(color, "")} height={height} width={width}>
